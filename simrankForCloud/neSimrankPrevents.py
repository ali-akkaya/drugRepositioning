...
print(f'Dataset Threats Shape: {dataWithPreventsPredicate.shape}')

print(dataWithPreventsPredicate.head())
data = dataWithPreventsPredicate.head(15104)
...
s_airports.to_parquet('simrankOfGraphOfPrevents.parquet', index=True)
